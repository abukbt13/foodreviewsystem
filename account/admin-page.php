        ...
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <div class="row">
                <div class="col col s4 m4 l4">
                    <img src="images/avatar.jpg" alt="No image" class="circle responsive-img valign profile-image">
                </div>
                ...
                <div class="col col s8 m8 l8">
                    <a class="btn-flat dropdown-button waves-effect waves-light white-text profile-btn" href="#" data-activates="profile-dropdown">Name from db
                        <br><i class="mdi-navigation-arrow-drop-down right"></i></a>
                    <p class="user-roal">Role from db</p>
                </div>
            </div>
            </li>
...
//									?>
      ...
      <section id="content">
            ...
            <div class="row">
              ...
              <div>
				...
				while($row = mysqli_fetch_array($result)) {
                    ...
                    echo '<tr>
                            <td>
                            <div class="input-field col s12"><label for="' . $row["id"] . '_name">Name</label>';
                           echo '<input value="' . $row["name"] . '" id="' . $row["id"] . '_name" 
                           name="' . $row['id'] . '_name"
                            type="text" data-error=".errorTxt' . $row["id"] . '">
                    ...
                    echo '<img src="./items/' .$row['image'] . '" id="' . $row["id"]
                        . '_image" name="' . $row['id'] . '_image" type="file" data-error=".errorTxt' . $row["id"] . '"><div class="errorTxt' . $row["id"] . '"></div>
                    </td></tr>';
                }
				?>
                    </tbody>
        ...
        <table>
			  ...
			  <div class="input-field col s12">
                              <button class="btn cyan waves-effect waves-light right" type="submit" name="add_item">Add
                                <i class="mdi-content-send right"></i>
                              </button>
                            </div>
            </div>
